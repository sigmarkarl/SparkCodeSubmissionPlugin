...
public final class ArrowConversion implements Serializable {
    ...
    private final Map<String, convertFrom<org.apache.arrow.vector.FieldVector, Integer, FieldType, FieldVector>> _fromConverters = new java.util.HashMap<>();
    //the to-converter container
    private final Map<String, convertTo<org.apache.arrow.vector.FieldVector, InternalRow[], Integer, DataType>> _toConverters = new java.util.HashMap<>();
    //the to-object-converter container
    private final Map<String, convertTo<org.apache.arrow.vector.FieldVector, Integer, Object, DataType>> _toObjectConverters = new java.util.HashMap<>();
    ...
    private static final Function<LocalDateTime, Long> _localDateTime_2_long = (ldt) -> DateTimeUtils.fromJavaTimestamp(Timestamp.valueOf(ldt));
    private static final BiFunction<Long, String, Long> _timestampSecTZ_2_long = (ss, zone) -> DateTimeUtils.fromJavaTimestamp(Timestamp.valueOf(LocalDateTime.from(Instant.ofEpochSecond(ss).atZone(ZoneId.of(zone)))));
    private static final BiFunction<Long, String, Long> _timestampMilliTZ_2_long = (mss, zone) -> DateTimeUtils.fromJavaTimestamp(Timestamp.valueOf(LocalDateTime.from(Instant.ofEpochMilli(mss).atZone(ZoneId.of(zone)))));
    private static final BiFunction<Long, String, Long> _timestampNanoTZ_2_long = (ns, zone) -> DateTimeUtils.fromJavaTimestamp(Timestamp.valueOf(LocalDateTime.from(Instant.ofEpochMilli(ns / 1000000L).atZone(ZoneId.of(zone)))));
    private static final BiFunction<Long, String, Long> _timestampMicroTZ_2_long = (ms, zone) -> DateTimeUtils.fromJavaTimestamp(Timestamp.valueOf(LocalDateTime.from(Instant.ofEpochMilli(ms / 1000L).atZone(ZoneId.of(zone))).plusNanos(ms % 1_000 * 1000L)));
    private static final Function<Timestamp, Long> _timestamp_2_long = DateTimeUtils::fromJavaTimestamp;
    ...
    private static final Function<Duration, Long> _duration_2_long = IntervalUtils::durationToMicros;
    ...
    private static final convertFrom<FieldType, Object, ValueVector, Object> _translate = (t, o, v) -> {
        switch (t.getTypeID()) {
            ...
            case TIMESTAMP:
                return (v instanceof TimeStampMilliVector) ? ArrowConversion._timestamp_2_long.apply((Timestamp)o)
                    ...
                    : (v instanceof TimeStampMicroVector || v instanceof TimeStampSecVector || v instanceof TimeStampNanoVector) ? ArrowConversion._localDateTime_2_long.apply((LocalDateTime)o) : o;
            case TIME:
            ...
            case DURATION_DAY_TIME:
                return (v instanceof IntervalDayVector || v instanceof DurationVector) ? ArrowConversion._duration_2_long.apply((Duration)o) : o;
            ...
            case LIST:
                return (v instanceof ListVector) ? ArrowConversion._translateList.apply((List<?>)o, (ListVector)v, (FieldType.ListType)t) : o;
            case MAP:
                return (v instanceof MapVector) ? ArrowConversion._translateMap.apply((List<?>)o, (MapVector)v, (FieldType.MapType)t) : o;
            case STRUCT:
                return (v instanceof StructVector) ? ArrowConversion._map_else_struct.apply((Map<String, ?>)o, (StructVector)v, (FieldType.StructType)t) : o;
            case NULL:
                return null;
        }
        return o;
